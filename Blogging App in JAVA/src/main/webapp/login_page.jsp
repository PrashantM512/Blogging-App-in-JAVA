...
<%@ page import="com.prash.blog.entities.Message"%>
<!DOCTYPE html>
<html>
<head>
...
<body>
					...
					<div class="col-md-4 offset-md-4">
						<div class="card">
							...
							<div class="card-body">
								...
								if (msg != null) {
									String css = msg.getCssclass();
								%>
								<div class="alert <%=css%>" role="alert"><%= msg.getContent()%></div>
								<%
	...
	<script>
		$(document).ready(
				function() {
					swal("Registration Successfull", "Now you can login...",
